...
import { handleGetDirPath, handleOpenDialog, handleSaveDialog, handleParseFilePaths, handleImagesToPdf } from './modules/handlers'
...
app.on('ready', () => {
  ...
  ipcMain.handle('imagesToPdf', handleImagesToPdf)
